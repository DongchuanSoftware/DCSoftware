...
HWidget::HWidget(QWidget *parent) : QOpenGLWidget(parent)
{
    i_colors=new QColor[255*6];
    for(int i=0;i<=0xff;i++)
    {
        i_colors[i]=QColor(255,i,0);
        //painter.drawLine(width()-60,i/(255*6/(double)height()),width()-30,i/(255*6/(double)height()));
    }
    for(int i=0xff-1;i>=0;i--)
    {
        i_colors[255*2-i]=QColor(i,255,0);
        //painter.drawLine(width()-60,(255*2-i)/(255*6/(double)height()),width()-30,(255*2-i)/(255*6/(double)height()));
    }
    for(int i=0;i<=0xff;i++)
    {
    ...
    for(int i=0xff-1;i>=0;i--)
    {
        ...
        //painter.drawLine(width()-60,(255*4-i)/(255*6/(double)height()),width()-30,(255*4-i)/(255*6/(double)height()));
    }
    for(int i=0;i<=0xff;i++)
    {
    ...
    for(int i=0xff-1;i>0;i--)
    {
        ...
        //painter.drawLine(width()-60,(255*6-i)/(255*6/(double)height()),width()-30,(255*6-i)/(255*6/(double)height()));
    }
